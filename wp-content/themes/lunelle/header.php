...
<body <?php body_class( 'dreamora-body' ); ?>>

<?php wp_body_open(); ?>

<div id="page" class="dreamora-site">
  ...
  <div class="cal-announce" role="region" aria-label="Promotions">
    <div class="cal-announce-track">
      <div class="cal-announce-content">
        ...
        <span>↩ 30 days risk-free — money back</span>
  ...
  <header class="cal-header" role="banner">
    <div class="cal-header-inner">
      ...
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Lunelle">
        <span class="cal-logo-text">LUNELLE</span>
      </a>
